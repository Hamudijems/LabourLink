...
export default function ManagementDashboard() {
  const { users, pendingUsers, loading: usersLoading } = useUsers()
  const { jobs, contracts, systemMetrics, loading: dataLoading } = useAppData()
                ...
                <CardContent className="space-y-4">
                  ...
                  {systemMetrics && (
                    <div className="text-xs text-gray-500 mt-4">
                      Last updated:{" "}
                      {systemMetrics.lastUpdated instanceof Date
